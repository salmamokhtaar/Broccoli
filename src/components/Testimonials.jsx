      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12" data-aos="fade-up">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Don't just take our word for it - hear from our satisfied customers about their experience with our organic products
          </p>
        </div>
            ...
            >
              <div className="bg-white p-8 rounded-lg shadow-lg relative mx-auto max-w-md">
                ...
                <div className="pt-6 text-center">
                  ...
                  <p className="text-gray-600 mb-6 italic">"{testimonials[activeIndex].quote}"</p>

                  <div className="flex justify-center text-yellow-500 mb-4">
                    {[...Array(5)].map((_, i) => (
                      <FaStar key={i} className={i < testimonials[activeIndex].rating ? 'text-yellow-500' : 'text-gray-300'} />
                    ))}
                  </div>

                  <div>
                    <h4 className="font-bold text-lg">{testimonials[activeIndex].name}</h4>
                    <p className="text-[#80B600] font-medium">{testimonials[activeIndex].role}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all ${
                    index === activeIndex ? 'bg-[#80B600] w-6' : 'bg-gray-300'
                  }`}
              ...
              >
                ...
                <div className="flex items-center mb-4 pt-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#80B600] text-sm font-medium">{testimonial.role}</p>
                  </div>
                </div>
