...
export default function Shop() {
  // Product data
  const products = [
    { id: 1, name: 'Fresh Apples', price: 39.00, image: f7, rating: 'empty' },
    { id: 2, name: 'Organic Carrots', price: 29.00, image: f8, rating: 'half' },
    { id: 3, name: 'Green Broccoli', price: 25.00, image: f9, rating: 'full' },
    { id: 4, name: 'Fresh Tomatoes', price: 19.00, image: f10, rating: 'half' },
    { id: 5, name: 'Red Peppers', price: 22.00, image: f11, rating: 'half' },
    { id: 6, name: 'Organic Lettuce', price: 18.00, image: f12, rating: 'full' },
    { id: 7, name: 'Fresh Cucumbers', price: 15.00, image: f13, rating: 'half' },
    { id: 8, name: 'Organic Spinach', price: 24.00, image: f14, rating: 'empty' },
    { id: 9, name: 'Fresh Strawberries', price: 45.00, image: f7, rating: 'full' },
    { id: 10, name: 'Organic Blueberries', price: 49.00, image: f8, rating: 'half' },
    { id: 11, name: 'Fresh Oranges', price: 35.00, image: f9, rating: 'empty' },
    { id: 12, name: 'Organic Lemons', price: 28.00, image: f10, rating: 'full' },
  ]
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {products.map((product) => (
          <div key={product.id} className="bg-white shadow-lg rounded-md overflow-hidden transition-transform duration-300 hover:scale-105">
